...
public class ConvertDate {
    ...
    public static String expandDate(String text) {
        Matcher matcher = ConvertDate.DATE_RE.matcher(text);
        while (matcher.find()) {
            String group = matcher.group();
            String s = ConvertDate.dateToChinese(group);
            text = text.replaceFirst(group, s);
        }
        return text;
    }

    private static String dateToChinese(String date) {
